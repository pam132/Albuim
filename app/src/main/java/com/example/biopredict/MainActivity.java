...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        predictBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                float TPValue = Float.parseFloat(ageInput);
                float AGratioValue = Float.parseFloat(weightInput);

                float[][] inputs = new float[1][2];
                inputs[0][0] = TPValue;
                inputs[0][1] = AGratioValue;

                float result = doInference(inputs);

                resultTV.setText("Albumin prediction: "+result);
            }
        });
    ...
    {
        AssetFileDescriptor assetFileDescriptor =    			this.getAssets().openFd("linearPam2.tflite");
